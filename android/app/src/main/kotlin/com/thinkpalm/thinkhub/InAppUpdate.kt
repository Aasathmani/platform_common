...
class InAppUpdatePlugin(var activity: Activity, var methodChannel: MethodChannel) : MethodCallHandler,
...
*/
    ...
    private fun checkForUpdate(result: Result) {
        ...
        appUpdateManager = AppUpdateManagerFactory.create(activity.getBaseContext())
