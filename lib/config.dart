...
import 'package:platform_common/src/utils/network_utils.dart';
...
class Development extends Flavor {
  @override
  String get name => FlavorName.development;
...
class Staging extends Flavor {
  @override
  String get name => FlavorName.staging;
...
class Production extends Flavor {
  @override
  String get name => FlavorName.production;
