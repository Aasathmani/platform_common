...
import 'package:platform_common/src/utils/network_auth_interceptor.dart';
import 'package:platform_common/src/utils/network_usage_interceptor.dart';

const androidPlayStoreUrl =
    'https://play.google.com/store/apps/details?id=com.platform.common';
...
const whiteListedAudioUtiTypes = [
  ...
  'com.microsoft.maridockform-audio',
...
const kBundleId = 'com.platform.common';
